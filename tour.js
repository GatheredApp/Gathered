(function (root, factory) {
  ...
  const slides = [
    ...
    { eyebrow: 'Prayer & Scripture', title: 'Find Scripture for a prayer.', body: 'Gathered prepares a thoughtful prompt asking for relevant Bible passages and YouVersion links.', note: 'Nothing is sent secretly. You choose whether to copy or share the prompt—and which AI assistant to use.', visual: icon('M12 14h40v29H29l-11 9v-9h-6zM23 25h18M23 32h12M45 8v10M40 13h10') },
