...
const APP_ASSETS = ['./', 'index.html', 'styles.css', 'enhancements.css', 'modal-controller.js', 'public-config.js', 'app.js', 'scripture-prompt.js', 'manifest.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png'];
